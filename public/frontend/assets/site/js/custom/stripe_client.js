$(document).ready(function () {
    ...
    $("#card-button").click(function () {
        ...
        if ($("#InputCountry").val().length == 0) {
            ...
            $("#InputCountry").after(
                '<span class="help-block InputCountry-error"></span>'
            );
            ...
            .then(function (result) {
                if (result.error) {
                    ...
                    if (result.error.message == "Invalid positive integer") {
                        var sessExpired =
                            '<div class="alert alert-warning"><h3>Your Session is Expired due to Inactivity</h3><p>Please select products again and add to cart.</p><p><a style="margin-top:20px;" onclick="window.history.back();" class="btn btn-default">Go Back</a></p></div>';
