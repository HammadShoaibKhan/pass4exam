        ...
        <div class="row">
            ...
            <div class="col-md-9 ci-right-body-wrpr">
                ...
                <div class="profile_edit">
                    ...
                    <form id="userProfileForm" name="userProfileForm" method="post" action="{{ route('user.profile.update') }}">
                        {{ csrf_field() }}
                        <div class="row margin-zero">

                            <div class="col-sm-6 padding-left-right-zero">
                                <div class="form-group">
                                    <label class="profile_label">Full Name / Company Name</label>
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $user->name }}">
                                </div>
                                <div class="form-group">
                                    <label class="profile_label">Email Address</label>
                                    <input type="email" id="email" class="form-control" placeholder="Enter your email id..." value="{{ $user->email }}" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="profile_label">Vat Number</label>
                                    <input type="text" name="vat_number" id="vat_number" class="form-control" value="{{ $user->vat_number }}">
                                </div>

                                <div class="form-group">
                                    <label class="profile_label">State</label>
                                    <input type="text" class="form-control" id="state" name="state" value="{{ $user->state }}">
                                </div>

                            </div>
                            <div class="col-sm-6 padding-left-7">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="profile_label">Zip</label>
                        ...
                        <div class="row margin-zero">
                            <div class="col-sm-12 padding-left-right-zero">
                                <button class="btn btn-lg btn-primary edit_profile_btn">Submit</button>
                            </div>
