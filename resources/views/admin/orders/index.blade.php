            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-2 offset-4">
                        <a href="javascript:;" class="btn btn-block btn-info btn-md change-order-status" data-route="{{ route('admin.orders.change-status') }}"><i class="fa fa-exchange-alt"></i>&nbsp;&nbsp; Change Status</a>
                    </div>
                </div>
                <br>
