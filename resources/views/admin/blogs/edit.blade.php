                        ...
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                          <div class="tab-pane active show fade" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                  <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST"  enctype="multipart/form-data" id="edit-blog-form">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                      <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" name="description" id="summernote" rows="10">{{$blog->description ?? '' }}</textarea>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 offset-10">
                                            <button class="btn btn-md btn-block btn-primary" type="submit">Update</button>
                                        </div>
                                    </div>
