        ...
        <div class="container cart_header">
            <div class="row">
                <div class="col-sm-3 col-xs-3 padding-top-7">
                    ...
                    {{-- <img src="https://www.study4exam.com/assets/site/image/back_buuton.png" class="margin-4"> --}}
                ...
                <div class="col-sm-6 col-xs-5 text-center">
                    <span class="cart_active">
                        <img src="https://www.study4exam.com/assets/site/image/cart_active.png">
                    </span>
                    <span class="cart_inactive">
                        <img src="https://www.study4exam.com/assets/site/image/cart_inactive.png">
                    </span>
                </div>
       ...
       {{-- END Header --}}
        ...
        <div class="container billing_form">
            <div class="row">
									 ...
									 <div class="col-sm-5 text-right padding-top-7">
										 <a href="https://www.study4exam.com/carts/remove_item/3956c7b8e1b9412c17b932da965aa596" onclick="return confirm('Are you sure! You want to remove?');"><img src="https://www.study4exam.com/assets/site/image/cart_cancel.png" class="cancel-img cancel-img-right"></a>
											<div class="form-group margin-bottom-10">
                                                ...
                                                <select name="cart_qty[]" id="cart_qty_3956c7b8e1b9412c17b932da965aa596" class="lisenceQty form-control center_box" onchange="return updateCartLisenceQty();">
											...
											<div class="form-group margin-bottom-0">
												                                				<select class="software-updates form-control center_box" id="subscription_3956c7b8e1b9412c17b932da965aa596" name="subscription[]" onchange="return updateCartLisenceQty();">
                                    				<option selected="selected" value="3" selected="selected">3 months (Free Updates)</option>
                                            		<option  value="6">6 months (Free Updates)</option>
                                            		<option  value="12">12 months (Free Updates)</option>
                                    			</select>
				...
				<div class="coupon-area">
                	<div class="coupon-field" style="display: none">
                		<div class="coupanAreaAdj">
                        		<div class="promocode">Promo code</div>
                        		<div class="form-group promo_code_input">
									...
									<button type="button" id="ApplyCouponNew" class="btn btn-warning apply">Apply</button>
                        		</div>
								<div id="codemsg" class="codemsg" style="color:red;"></div>
                        </div>
                	</div>
                	<div class="couponApplied" style="display: block">
                    	<h4 style="display: inline-block; width: 100%;">Discount</h4>
                    	<div class="product-row" id="applied">
                    			...
                    			<p>Promotional Code <span style="color: #0babb5" class="disCode">“SAVE50”</span><br>
                ...
                <div class="row">
                    <div class="col-xs-6">
                       <div class="Summaryheading">Subtotal</div>
                    </div>
                    <div class="col-xs-6 text-right">
                       <div class="Summaryheading"><span class="pull-right">$256.00</span></div>
					</div>
                </div>
                <div class="row">
					<div class="col-xs-6">
						<div class="Summaryheading">Discount</div>
                    </div>
                    <div class="col-xs-6 text-right">
                       <div class="Summaryheading"><span id="DiscountAmount " class="pull-right DiscountAmount">$128.00</span><div class="discountInfo">(50% Off)</div> </div>
                    </div>
                </div>
                <div class="total_payment">Total Payment &nbsp; <span class=" GrandTotalAmount">$128.00</span></div>
               </div>
               <div class="col-lg-6 col-lg-6 col-md-12 col-xs-12 col-sm-12 padding-right-33 billingInfoBox">
                  ...
                  <form action="https://www.study4exam.com/carts/viewCart" id="checkoutForm" name="checkoutForm" role="form" class="validate" method="post" accept-charset="utf-8">
					    ...
					    <div class="heading">
					 	...
					 	<div class="row">
							<div class="col-sm-6 col-xs-12">
									...
									<input onkeyup="saveValue(this);" type="text" required="required" placeholder="Card Holder Name" name="first_name" class="form-control" id="cardholderName" value="Daniel" required="required">
							...
							<div class="col-sm-6 col-xs-12">
								<div class="form-group">
									<label for="email">Email</label>
    								    ...
    								    <input onkeyup="saveValue(this);" type="text" required="required" readonly="readonly" name="email" class="form-control" id="email" placeholder="Enter Your Email" value="danielisaac745@gmail.com">
    									<span class="help-block email-error"></span>
    																</div>
							</div>
							<div id="emailCheckError" class="row error-msg" style="display:none;">
								  <div class="col-sm-7">
									 <div class="msg" id="loginCheck"></div>
								  </div>
								  <div class="col-sm-5">
									 <div class="login_account">
										<a href="#" data-toggle="modal" data-target="#login_box">Login to your account</a>
									 </div>
								  </div>
						    </div>
							<div class="col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<input onkeyup="saveValue(this);" type="text" required="required" name="street_address" class="form-control" id="street_address" placeholder="Enter Your Street Address" value="">
					...
					<div class="paymentareacartcss hide-card">
            			...
            			<img style="float: right;margin-right: -1px;height: 38px;margin-top: -7px;" src="https://www.study4exam.com/assets/site/cart-images/payment-sp.png" alt="" class="stripe-img">
        			</div>
					  		...
					  		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding" id="CardInfo">
							    ...
							    <div class="row" id="CardPayBtnBox">
								  <div class="col-sm-4 col-xs-4">
									 ...
									 <button type="button" id="card-button" class="btn btn-warning pay-now-btn" data-tid="elements_examples.form.pay_button">PAY NOW</button>
								  </div>
								  <div class="col-sm-7 col-xs-7 pull-right  zero-padding">
									 <div class="desc-paynow">
									    Your Purchase with Study4Exam is secure. The product will be available for immediate download after your payment has been processed.
										
									 </div>
								  </div>
								  <div class="col-sm-12">
									<div class="clearfix"></div>
									<div class="stripeResponse" style="background: coral;padding: 10px;color: #fff;display: none; margin: 10px 0"></div>
									<div class="clearfix"></div>
								  </div>
							   </div>
					  			<!-- end pay for cards-->
               ...
               <div class="col-sm-4 col-xs-4">
                  <div class="row">
                     <div class="col-sm-3 col-xs-12">
                        <img src="https://www.study4exam.com/assets/site/image/gurrentee.png" class="img-responsive" alt="">
                     </div>
                     <div class="col-sm-9 col-xs-12 padding-left-5 infoTxtBox">
                        <h4>100% Money back Guaranteed</h4>
                        <p>Your investment will be secured with Study4Exam, as you will never be at losing anything. </p>
                     </div>
                  </div>
               </div>
               <div class="col-sm-4 col-xs-4">
                  <div class="row">
                     <div class="col-sm-3 col-xs-12">
                        <img src="https://www.study4exam.com/assets/site/image/gurrentee2.png" class="img-responsive" alt="">
                     </div>
                     <div class="col-sm-9 col-xs-12 padding-left-5 infoTxtBox">
                        <h4>24/7 Customer Support</h4>
                        <p>We offer you 24/7 free customer support to make your learning smooth and hassle free.  </p>
                     </div>
                  </div>
               </div>
               <div class="col-sm-4 col-xs-4">
                  <div class="row">
                     <div class="col-sm-3 col-xs-12">
                        <img src="https://www.study4exam.com/assets/site/image/gurrentee3.png" class="img-responsive" alt="">
                     </div>
                     <div class="col-sm-9 col-xs-12 padding-left-5 infoTxtBox">
                        <h4>Free 3 Months Updates</h4>
                        <p>Study4Exam offers you with 3 months free updates, upon purchase. Once you will buy any of our products you will be subscribed to free updates</p>
                     </div>
                  </div>
               </div>
            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <div class="modal-title">Sign in</div>
             <a href="#" data-dismiss="modal">
                  <img src="https://www.study4exam.com/assets/site/image/cart_cancel.png" class="login-cancel_btn">
            </a>
         </div>
        ...
        <div class="modal-body">
		 ...
		 <form method="post" name="userLoginForm" id="userLoginForm" action="https://www.study4exam.com/login">
         <div class="form-group">
             <label for="name" class="formlabel">E-mail Address</label>
         ...
         <div class="row">
            <div class="col-sm-6">
               <button type="submit" class="btn btn-warning login_btn">Sign in</button>
            </div>
            <div class="col-sm-6 text-right">
               <a href="https://www.study4exam.com/login/forgot_password" class="forgot_password">Forgot password?</a>
            </div>
         </div>
		 </form>
         </div>
...
<script>
	...
	$.ajax({         
	 ...
	 success: function(response) {
                          if(response.status == 'success')             {                 console.log(1);                              }             else             {                console.log(0);             }         }     })
        app.submit();
    }
    }
