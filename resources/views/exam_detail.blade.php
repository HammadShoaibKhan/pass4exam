                        ...
                        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 mb-4"> 
                            <div class="row">
                                ...
                                <div id="sample_page_2_top_content" class="col-xl-9 col-lg-9 col-md-8 col-sm-7 mb-4">
                                    ...
                                    <p>Study4exam offers web-based and desktop practice tests for your easier preparation of the Microsoft AZ-900 certification exam.
                                ...
                                <div class="tryonlineBtn col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4 m-auto text-center" >
                                    <div>
                                        <form method="post" action="https://www.study4exam.com/opt_demo/online.php" id="demos_form" name="demos_form" target="_blank">
                                ...
                                <div id="sample_page_2_middle_content_inner" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-4 mb-4" >
                                    ...
                                    <p>
                                        ...
                                        To meet the learning needs of every candidate, the Study4exam more effective.
                                    </p>                 
                                </div>
                                {{-- END <!-------------Feature Banner----------------------------------------> --}}
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 mb-4 sample_page_2_right_bar">
                            ...
                            <div class="sample_page_2_right_bar_blog">
                                ...
                                <div class="sample_page_2_right_bar_blog_links">
                                    <ul>
                                        <li>
                                            <a href="https://www.study4exam.com/mongodb/c100dba" class="btun margin-right">
                                                <span>C100DBA </span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.study4exam.com/oracle/1z0-343" class="btun margin-right">
                                                <span>1Z0-343 </span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.study4exam.com/microsoft/mb-700" class="btun margin-right">
                                                <span>MB-700 </span>
                                            </a>
                                        </li>
                                    </ul>
