                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="textdivtopnav">
                            <h2>{{$exam->vendor_title ?? ''}} {{$exam->exam_code ?? ''}} Web-Based Practice Exam</h2>
                            <p>{{$exam->title ?? ''}}</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="tab-content margtop100">
                <div id="menu1" class="tab-pane fade in active">
                    ...
                    <h3 class="text-center">
                        Customize your Practice Attempt(Optional)
                    </h3>

                    {{-- Central Content --}}
                    <div class="row">
                        <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                            <form method="post" action="{{ route('exam.premium.practice') }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="exam_id" value="{{ $exam->id }}">
                                <input type="hidden" name="exam_type" value="premium">
                                <div class="row">
                                    {{-- Case Study --}}
                                                ...
                                                @forelse($exam->caseStudies as $key => $caseStudy)
                                                    <div class="col-lg-3 col-md-4 col-sm-4">
                                                        <label  class="checkbox-inline">
                                                            ...
                                                            data-val="14" value="{{ $caseStudy->id }}" name="case_studies[]" id="cs1">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 Allquestiontab">
                                        <div class="form-group hideifSpecific columnstylings">
                                            ...
                                            <input type="range" min="1" max="{{ $exam->getTotalQuestions() }}"
